  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Connecto is developed by <span style="font-weight: 700;">BE Comp B10</span>  for networking purpose.</p>
        <p>The Connecto includes posts, reposts, quote or even quote the quoted posts, like posts and nested comments.
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/connecto.png"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
      ...
      <div class="grid-posts">
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="Share" value="Share" class="submit"
                            >
                          </div>
                      </div>
                      </form>
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Connecto">
