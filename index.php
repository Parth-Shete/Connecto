...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/png" href="assets/images/connecto.png"> 
	</head>
<body>
<main class="twt-main">
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="<?php echo BASE_URL . "/assets/images/connecto.png"; ?>" alt="bird">
                        ...
                        <span class="join">Join Connecto Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2024 - Connecto</li>
                    <li style="color:#1DA1F2;"><b>- Developed By BE Comp B10 -</b></li>
                </ul>
            </footer>
        </main>
